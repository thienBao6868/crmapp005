                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="task-add" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  readonly value="${task.project.name}"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  readonly value="${task.start_date}"
                                            class="form-control form-control-line" > 
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  readonly value="${task.end_date}"
                                            class="form-control form-control-line" > 
                                    </div>
                                </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  readonly value="${task.status.name}"
                                            class="form-control form-control-line" > 
                                    </div>
                                </div>
                                <div class="form-group">
