						...
						<div class="white-box">
							<form class="form-horizontal form-material" action="api/profile-edit?id_task=${taskById.id}" method="post">
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${taskById.project.name}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${taskById.name}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${taskById.start_date}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" readonly value="${taskById.end_date}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
